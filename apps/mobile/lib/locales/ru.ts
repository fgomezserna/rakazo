export const RU_MESSAGES: Record<string, string> = {
  ...
  "Could not add shared bot": "Не удалось добавить общего бота",
  ...
  "Could not remove shared bot": "Не удалось удалить общего бота",
  "Could not revoke share": "Не удалось отменить общий доступ",
  ...
  "Another workspace": "Другое рабочее пространство",
  "Shared bots": "Общие боты",
  "Share with workspaces": "Поделиться с рабочими пространствами",
  "Shared bots keep their own memory, credentials, and execution.":
    "Общие боты сохраняют собственную память, учетные данные и выполнение.",
  ...
  "Could not share bot": "Не удалось поделиться ботом",
