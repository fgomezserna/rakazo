export const ZH_MESSAGES: Record<string, string> = {
  ...
  "Could not update workspace": "无法更新工作区",
  "Could not load workspace": "无法加载工作区",
  "Could not read that image": "无法读取图片",
  "Only the workspace owner can configure it": "只有工作区所有者可以配置工作区",
  "Photo access required": "需要照片访问权限",
  "Allow photo access to choose an avatar.": "请允许照片访问权限以选择头像。",
  "Reading…": "读取中…",
  Connected: "已连接",
  ...
  "Could not add shared bot": "无法添加共享 Bot",
