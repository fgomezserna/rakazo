...
import {
  ...
  MoveBotToSpaceInput,
  RemoveGroupGuestInput,
  ReorderBotsInput,
  RevokeBotWorkspaceShareInput,
  RoutineSchema,
...
export const appContract = {
  ...
  bots: {
    ...
    shares: {
      list: oc.input(botId).output(z.array(BotWorkspaceShareSchema)),
      create: oc.input(CreateBotWorkspaceShareInput).output(BotWorkspaceShareSchema),
      revoke: oc.input(RevokeBotWorkspaceShareInput).output(z.object({ ok: z.literal(true) })),
    },
    reorder: oc.input(ReorderBotsInput).output(z.object({ ok: z.literal(true) })),
    moveToSpace: oc.input(MoveBotToSpaceInput).output(BotSchema),
  ...
  groups: {
    ...
    guests: {
      add: oc.input(AddGroupGuestInput).output(GroupSchema),
      remove: oc.input(RemoveGroupGuestInput).output(GroupSchema),
      setMode: oc.input(SetGroupGuestModeInput).output(GroupSchema),
    },
